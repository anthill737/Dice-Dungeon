...
## Mirrors Python save/load dialog layout.
...
func _build_ui() -> void:
	...
	# Two-panel layout (matching Python left/right split)
	...
	_detail_panel.size_flags_stretch_ratio = 0.55
...
func refresh() -> void:
	...
	# Disable save during combat (matching Python)
